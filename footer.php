                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 col-lg-3">
                        <div class="footer__social">
                            ...
                            <a href="<?php the_field('instagramm', 2); ?>" target="_blank" class="footer__social-item">
                            ...
                            <a href="<?php the_field('facebook', 2); ?>" target="_blank" class="footer__social-item">
                            ...
                            <a href="<?php the_field('youtube', 2); ?>" target="_blank" class="footer__social-item">
                        ...
                        <div class="footer__contacts">
                            <div class="footer__contacts-item">
                                ...
                                <div class="footer__contacts-tel">
                                    <a href="tel:<?php the_field('number_phone_one'); ?>"><?php the_field('number_phone_one', 2); ?></a>
                                    <a href="tel:<?php the_field('number_phone_two'); ?>"><?php the_field('number_phone_two', 2); ?></a>
                                </div>
                            </div>
                            <div class="footer__contacts-item">
