...
?>
        ...
        <div class="specialists" id="specialists">
            <div class="container">
                <div class="title"><?php the_field('title_team', 2); ?></div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <div class="toys__alert">
                            <span><?php the_field('text_question'); ?></span><?php the_field('text_descr'); ?>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="aboutus" id="aboutus">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="subtitle">
                            <?php the_field('subtitle_one'); ?>
                        </div>
                        <div class="aboutus__text">
                            <?php the_field('descr_one'); ?>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <img class="aboutus__img" src="<?php the_field('image_one'); ?>" alt="мир детства">
                    </div>
                </div>

                <div class="row">
                    <div class="col-lg-6">
                        <img class="aboutus__img" src="<?php the_field('image_two'); ?>" alt="мир детства">
                    </div>
                    <div class="col-lg-6">
                        <div class="subtitle">
                            <?php the_field('subtitle_two'); ?>
                        </div>
                        <div class="aboutus__text">
                            <?php the_field('descr_two'); ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="subtitle">
                            <?php the_field('subtitle_three'); ?>
                        </div>
                        <div class="aboutus__text">
                            <?php the_field('descr_three'); ?>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <img class="aboutus__img" src="<?php the_field('image_three'); ?>" alt="мир детства">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="contacts" id="contacts">
            <h1 class="title"><?php the_field('title_search'); ?></h1>
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="contacts__descr underlined">
                            <?php the_field('search_address'); ?>
                        </div>
                    </div>
                    <div class="col-lg-6">
                            ...
                            <div class="contacts__phones">
                                <div class="contacts__phoneblock">
                                    ...
                                    <div class="contacts__phonewrap">
                                        ...
                                        <a href="tel:<?php the_field('number_phone_one', 2); ?>"><?php the_field('number_phone_one', 2); ?></a>
                                    </div>
                                </div>
                                <div class="contacts__phoneblock">
                                    Телефон №2
